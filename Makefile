...
SOURCES = \
	__init__.py \
	fastcutter.py fastcutter_dialog.py

PLUGINNAME = fastcutter

PY_FILES = \
	__init__.py \
	fastcutter.py fastcutter_dialog.py

UI_FILES = fastcutter_dialog_base.ui
...
QGISDIR=C:\Users\emanu\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
